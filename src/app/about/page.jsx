      ...
      <main>
        <section className="w-full h-auto md:h-auto">
          <div className="pt-36 md:pt-52 pb-5 md:pb-20">
            <h1 className="font-fairplay text-[46px] md:text-[80px] text-greenl text-center font-bold px-10 md:px-0 revAnim">
              I{"'"}m Riyan.
            </h1>
          </div>
          <div className="w-full h-auto pb-10 md:pb-20 md:py-20 flex flex-col px-2 md:px-20 md:flex-row">
            ...
            <div className="md:w-2/5 flex justify-center ">
              <h1 className="text-greenls text-xl md:text-3xl font-sans text-center revAnim2 opacity-0">
            ...
            <div className="md:w-3/5 md:ml-12 flex flex-col gap-5 pt-20 md:pt-0 px-5 md:px-0">
              <h1 className="font-bold font-fairplay text-greenl text-2xl md:text-4xl revAnim2 opacity-0">
              ...
              <p className="font-sans text-white font-thin md:font-normal revAnim2 opacity-0">
                ...
                Next.js, a powerful framework for building React applications. I
                {"'"}m excited to leverage Next.js to develop fast, scalable,
